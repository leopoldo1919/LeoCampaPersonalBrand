export const ca = {
  ...
  hero: {
    title: 'Leo Campa',
    subtitle: 'Desenvolupador Frontend',
    description: 'Creant experiències web boniques i funcionals amb tecnologies modernes.',
  ...
  contact: {
    title: 'Contacte',
    subtitle: 'Sempre estic obert a noves oportunitats i projectes. No dubtis a contactar-me!',
